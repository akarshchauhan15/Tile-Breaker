...
public class TilePresets
{
    ...
    public static TilePreset TENxTEN = new TilePreset(new Vector2(10, 10), new Vector2(106, 27), new Vector2(8, 8), new Vector2(80, 80));
    public static TilePreset TENxTWELVE = new TilePreset(new Vector2(10, 12), new Vector2(90, 27), new Vector2(8, 8), new Vector2(60, 80));
